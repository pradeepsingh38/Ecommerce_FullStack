...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.14.tgz':
    resolution: {integrity: sha512-Cg1cOFeGXGu/AzD1Uuu1J6rOGuMzk7t2td0sQY5B6elNyxwSh7cq99FWW2xkq7DapJbBylfedacGatw+i8GmeQ==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.14.tgz}
    version: 2.8.14
    bundledDependencies:
      - '@oai/walnut'
      - skia-canvas
